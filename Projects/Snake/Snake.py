...
dis=pygame.display.set_mode((800,400))      #This line of code creates the screen that will be used for the game
...
x1 = 300                                                #This line of code sets the starting x coordinate position for the head of the snake 
y1 = 300                                                #This line of code sets the starting y coordinate position for the head of the snake 
...
while not game_over:                                     #This line of code is a loop that says that the screen will not go away until the game_over variable is set to True
    ...
    pygame.draw.rect(dis, black, [x1, y1, 10, 10])      #This line of code draws a rectangle in the display at the given cordinates
 
    pygame.display.update()                             #This line of code updates the screen
 
    clock.tick(30)                                      #This line of code sets the speed for the snake
